...
foreach ($overload_fields as $fieldname=>$fieldtype) {
        ...
        if ($overload_fields[$fieldname]["type"] == "textarea" )
            echo "<tr><td><textarea cols=\"80\" rows=\"2\" name=\"addon_".$overload_fields[$fieldname]["id"]."\">".my_htmlspecialcharacters(removeMailUnicode($data))."</textarea></td></tr>\n";
        else if ($overload_fields[$fieldname]["type"] == "text" )
            echo "<tr><td><input size=\"80\" type=\"text\" name=\"addon_".$overload_fields[$fieldname]["id"]."\" value=\"".my_htmlspecialcharacters(removeMailUnicode($data))."\" /></td></tr>\n";
        else if ($overload_fields[$fieldname]["type"] == "numeric" )
            echo "<tr><td><input size=\"20\" type=\"text\" name=\"addon_".$overload_fields[$fieldname]["id"]."\" value=\"".my_htmlspecialcharacters(removeMailUnicode($data))."\" /></td></tr>\n";
        else {
